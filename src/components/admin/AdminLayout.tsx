        ...
        <div className="h-full flex flex-col p-6">
          ...
          <nav className="flex-1 space-y-2">
            {navItems.map((item) => (
              <Link 
                ...
                href={item.href}
                className={cn(
                  "flex items-center space-x-3 px-4 py-3 rounded-lg transition-all font-code text-xs uppercase tracking-widest group",
                  pathname === item.href 
              ...
              >
                <item.icon className={cn("w-4 h-4", pathname === item.href ? "text-white" : "group-hover:text-primary transition-colors")} />
                <span>{item.name}</span>
              </Link>
            ))}
          </nav>
          ...
          <div className="mt-auto pt-6 border-t border-white/10">
            ...
            >
              ...
              <span className="font-code text-xs uppercase tracking-widest">Logout</span>
            </Button>
          </div>
        </div>
      </aside>
